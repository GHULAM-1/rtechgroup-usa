...
const CreateRental = () => {
  ...
  const onSubmit = async (data: RentalFormData) => {
    ...
    try {
      ...
      // If there's an initial fee, create payment record (automatic trigger will handle processing)
      if (data.initial_fee && data.initial_fee > 0) {
        ...
        console.log('Initial payment created:', initialPayment.id, '- automatic processing via trigger');
      }
