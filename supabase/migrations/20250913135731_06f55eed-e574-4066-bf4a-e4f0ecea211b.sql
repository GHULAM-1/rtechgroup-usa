...
-- 3) Drop and recreate view_pl_by_vehicle to fix Initial Fees column
...
-- 4) Drop and recreate vehicle_pnl_rollup view for future date-based filtering
DROP VIEW IF EXISTS public.vehicle_pnl_rollup;

CREATE VIEW public.vehicle_pnl_rollup AS
SELECT
    v.id as vehicle_id,
    v.make,
    v.model,
